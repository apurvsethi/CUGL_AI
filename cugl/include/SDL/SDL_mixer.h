...
#pragma mark -
#pragma mark CUGL EXTENSIONS

/** Modify a running channel */
extern DECLSPEC int SDLCALL Mix_SetLoop(int channel,int loops);
extern DECLSPEC int SDLCALL Mix_SetOffset(int channel, int offset);
extern DECLSPEC int SDLCALL Mix_GetOffset(int channel);
extern DECLSPEC int SDLCALL Mix_SetMusicLoop(int loops);
extern DECLSPEC double SDLCALL Mix_GetMusicDuration(Mix_Music* music);
