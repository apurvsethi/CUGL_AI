#ifndef __CU_Formation_A_Star_Path_Finder_H__
#define __CU_Formation_A_Star_Path_Finder_H__
 ...
 * recomputation.
 */
class FormationAStarPathFinder : public PathFinder {
public:
#pragma mark Constructors

    /**
     * Creates a new A* search path finder for a formation.
     *
     * NEVER USE A CONSTRUCTOR WITH NEW. If you want to allocate an object on
     * the heap, use one of the static constructors instead.
     */
    FormationAStarPathFinder();

    /**
     * Deletes this A* path finder, disposing all resources.
     */
    virtual ~FormationAStarPathFinder();

#pragma mark Static Constructors
    /**
     * Allocated a A* path finder for a given formation and world.
     * 
